...
$miFrase = "PHP es un lenguaje muy versátil, ya que PHP se utiliza para crear sitios dinámicos y es interesante ver como PHP se integra con base de datos.<br>"; // Reemplaza esto con tu frase
