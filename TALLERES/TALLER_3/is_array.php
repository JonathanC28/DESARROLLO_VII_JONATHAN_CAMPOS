...
$miArray = ["Toyota", "Honda", "Mazda", "Nissan", "Mitsubishi"]; // Reemplaza esto con tu propio array
$miString = "Carros Japoneses"; // Reemplaza esto con tu propio string
$miNumero = 5; // Reemplaza esto con tu propio número
