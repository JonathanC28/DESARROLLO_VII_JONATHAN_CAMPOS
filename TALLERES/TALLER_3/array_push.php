...
$misAmigos = ["Juan", "Alberto", "Ricardo"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Marcos", "Mario"); // Reemplaza las comillas vacías con los nombres de tus amigos
